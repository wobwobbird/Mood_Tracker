    ...
    const title = () => {
        return (
            <Box flexDirection="column">
                ...
                <Text color={logoColourSchemes[logoColourIndex][3]}>{'$$\\$$\\$$ $$ |$$  __$$\\ $$  __$$\\ $$  __$$ |      $$ |     $$  __$$\\ $$  __$$\\ $$  __$$\\ $$  __$$\\ $$  __$$\\'}</Text>
...
// $$ |\$  /$$ |$$ |  $$ |$$ |  $$ |$$ |  $$ |$$ |     $$ |  $$ |$$ |  $$ |$$ |  $$ |$$   ____|$$ |      
// $$ | \_/ $$ |\$$$$$$  |\$$$$$$  |\$$$$$$$ |$$$$$$$$\\$$$$$$  |\$$$$$$$ |\$$$$$$$ |\$$$$$$$\ $$ |      
// \__|     \__| \______/  \______/  \_______|\________|\______/  \____$$ | \____$$ | \_______|\__|      
//                                                               $$\   $$ |$$\   $$ |                    
//                                                               \$$$$$$  |\$$$$$$  |                    
//                                                                \______/  \______/                     
...
// '$$$\\    $$$ |                          $$ |         $$ |                                                       '
// '$$$$\\  $$$$ | $$$$$$\\   $$$$$$\\   $$$$$$$ |       $$ |      $$$$$$\\   $$$$$$\\   $$$$$$\\   $$$$$$\\   $$$$$$\  '}</Text>
// '$$\\$$\\$$ $$ |$$  __$$\\ $$  __$$\\ $$  __$$ |      $$ |     $$  __$$\\ $$  __$$\\ $$  __$$\\ $$  __$$\\ $$  __$$\ '}</Text>
// '$$ \\$$$  $$ |$$ /  $$ |$$ /  $$ |$$ /  $$ |         $$ |     $$ /  $$ |$$ /  $$ |$$ /  $$ |$$$$$$$$ |$$ |  \\__|'}</Text>
// '$$ |\\$  /$$ |$$ |  $$ |$$ |  $$ |$$ |  $$ |         $$ |     $$ |  $$ |$$ |  $$ |$$ |  $$ |$$   ____|$$ |      '}</Text>
// '$$ | \\_/ $$ |\\$$$$$$  |\\$$$$$$  |\\$$$$$$$ |      $$$$$$$$\\\\$$$$$$  |\\$$$$$$$ |\\$$$$$$$ |\\$$$$$$$\\ $$ |      '}</Text>
// '\\__|     \\__| \\______/  \\______/  \\_______|     \\________|\\______/  \\____$$ | \\____$$ | \\_______|\\__|      '}</Text>
// '                                                                    $$\\   $$ |$$\\   $$ |                    '}</Text>
// '                                                                    \\$$$$$$  |\\$$$$$$  |                    '}</Text>
// '                                                                     \\______/  \\______/                     '}</Text>
